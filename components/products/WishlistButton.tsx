...
export default function WishlistButton({
  ...
  return (
    <button
      ...
      aria-pressed={wished}
      className="absolute top-1.5 right-1.5 z-20 w-10 h-10 md:w-10 md:h-10 rounded-full flex items-center justify-center transition active:scale-95 disabled:opacity-70"
      style={{
        background: wished
          ? 'rgba(160,69,46,0.92)'
