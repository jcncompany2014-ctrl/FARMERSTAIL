...
// ★"언제든 해지" 금지 (사장님 2026-07-23, 2026-08-02 검수에서 여기 남은 것 발견).
//   과약속이라 쓰지 않기로 한 문구인데, 하필 **모든 웹 페이지 상단**에 떠 있었다.
//   대신 마감을 명시한다 — 해지의 실제 마감은 일요일이 아니라 **다음 결제 전**이고
//   (status 를 바꾸는 순간 next_delivery_date 가 지워지고 청구 크론은 active 만
//   고른다), 그 정본 문구가 lib/shipping-schedule 의 STOP_TIMING_COPY 다.
//   일요일 마감인 것은 해지가 아니라 **박스 구성 변경**이다 — 섞지 말 것.
const PROMO_MESSAGES = [
  '무료 분석 먼저, 결제는 그다음 · 다음 결제 전까지 해지',
  '설문으로 우리 아이 맞춤 설계 · 구독 강요 없음',
  '수의영양 기준으로 설계한 화식 · 사람이 먹는 등급 원물',
  '배송비는 구독료에 포함 · 미개봉 7일 내 환불',
] as const
