...
const STEPS = [
  ...
  },
  {
    ...
    accent: 'var(--moss)',
    kicker: 'Step 3 · 정기배송',
    // '매주 또는 매월'은 낱개 커머스 시절 잔재였다 — 지금은 **2주마다 화요일
    // 발송 고정**이고 주/월 선택은 없다(lib/shipping-schedule). '도착'도 발송일과
    // 다르다(도착은 지역에 따라 하루~이틀). 2026-07-30 수정.
    title: '2주마다 화요일 발송',
    body: '맞춤 박스를 2주마다 보내드려요.\n다음 결제 전까지 일시정지·해지할 수 있어요.',
  },
] as const
