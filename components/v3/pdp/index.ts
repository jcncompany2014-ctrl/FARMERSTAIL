/**
 * v3 PDP sections barrel — 앱 (data-ft-chrome="app") 전용.
 */

export { default as PdpHeroGallery } from './PdpHeroGallery'
export { default as PdpTitleBlock } from './PdpTitleBlock'
...
export type { WhyReason } from './PdpWhyRecipe'
