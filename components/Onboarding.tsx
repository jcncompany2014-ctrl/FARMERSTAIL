...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    badges: [
      ...
      // ★75% 였다가 65% 로 올렸다(2026-09-09). 자산을 재촬영해 문장이 온전히
      //   들어오게 되자, 이 배지가 카드 안 'AAFCO · FEDIAF · NRC 기준 충족'
      //   줄의 앞부분만 가려 'F · NRC 기준' 이라는 토막이 남았다. 배지 폭은
      //   못 늘리고 왼쪽으로 더 뺄 여유도 없어서(왼쪽 끝이 화면 밖으로 나간다),
      //   그 줄을 통째로 노출하고 배지는 그 위 본문을 덮게 올렸다 —
      //   배지의 '국제 기준' 과 실물 규격명이 나란히 읽혀 오히려 낫다.
      { text: '국제 기준 충족', side: 'left', top: '65%', Icon: ShieldCheck },
    ],
  },
  {
  ...
  },
  {
    ...
    // ★'배송일 변경' 은 금액 줄(120,000원)을 **일부러 덮는다**(2026-09-08 사장님:
    //   "덮으라는 소리였음, 숫자 잘 안 보이게"). 온보딩은 아직 가입 전 화면이라
    //   구체 금액이 먼저 눈에 박히면 부담으로 읽힌다 — 가격은 설문·플랜에서
    //   맥락과 함께 보여준다. 위치를 옮길 땐 이 의도를 깨지 않게 할 것.
    badges: [
      { text: '배송일 변경', side: 'left', top: '28%', Icon: Truck },
