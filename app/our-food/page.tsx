...
const FOOD_FAQ = [
  ...
  { q: '입이 짧은 아이도 잘 먹을까요?', a: '신선한 화식은 기호성이 높은 편이지만 개체차가 있어요. 첫 박스로 먼저 반응을 확인해 보세요 — 잘 안 맞으면 언제든 해지할 수 있어요.' },
  { q: '배송과 보관은 어떻게 하나요?', a: '급속 냉동해 콜드체인으로 문 앞까지 보내요(배송비는 구독료에 포함). 받으면 냉동 보관하고, 급여 전 냉장에서 해동해 주세요.' },
  { q: '약정이 있나요?', a: '없어요. 첫 박스만 받아보고 바로 해지해도 괜찮고, 배송 주기 변경·일시정지·해지는 언제든 자유예요.' },
]
