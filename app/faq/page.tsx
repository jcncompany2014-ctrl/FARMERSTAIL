  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: '네, 언제든 가능합니다. 마이페이지 → 정기배송 → ‘상품 변경’ 에서 원하는 단백질로 자유롭게 바꿀 수 있어요. 추가 비용이나 위약금은 없고, 발송 1주일 전까지 변경하면 다음 박스부터 새 구성으로 나갑니다. 알레르기 정보가 등록돼 있다면 우리 아이가 안전하게 먹을 수 있는 구성만 골라서 보여드리니, 여러 단백질을 마음 편히 번갈아 시도해 보셔도 좋아요.',
      },
      {
        q: '연휴엔 배송이 어떻게 되나요?',
