...
const FALLBACK_GROUPS: Group[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: '갑작스런 전환은 장에 부담이 될 수 있어요. 7일에 걸쳐 화식 비율을 25% → 50% → 75% → 100% 로 늘려가는 방식을 권장합니다. ‘첫 화식 입문’ 구성이 그 일주일 분량을 묶어 두었어요.',
      },
      {
        q: '알레르기가 있는 아이는 어떻게 해야 하나요?',
        a: '단일 단백질 라인 또는 알레르기 케어 구성을 참고해 주세요. 원재료표에 모든 성분을 표기합니다.',
      },
      {
      ...
      },
      {
        ...
        a: '입맛은 아이마다 다를 수 있어요. 미개봉 상태라면 수령 7일 이내 단순 변심 환불이 가능합니다. 이미 개봉했다면 단백질 종류를 바꿔보는 걸 추천드려요 — 고객센터로 연락 주시면 다른 구성 1팩을 50% 할인 쿠폰으로 보내드립니다.',
      },
      {
        q: '영양 균형은 어떻게 맞추나요?',
