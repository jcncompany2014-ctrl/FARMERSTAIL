  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: '냉동(-18℃ 이하)은 12개월까지 보관할 수 있어요. 급여 전날, 그날 필요한 만큼만 냉장실로 옮겨 12시간 자연 해동하세요. / 냉장(0~10℃)은 수령 후 7일 이내 급여를 권장하고, 개봉하거나 해동한 뒤에는 3일 안에 드세요. 화식은 신선식이라 해동한 채 오래 두면 상할 수 있어서, 한 번에 2~3일치만 해동해 3일 안에 소진하는 걸 권해요.',
      },
    ],
  },
  {
