      ...
      >
          ...
          <UL>
            ...
            <li>
              {/* ★문구를 실제 동작과 정합화 (2026-08-19 5라운드 감사). 예전엔
                  ...
                  수령 후는 고객센터 접수로 안내한다. */}
              <b>방법:</b> 출고 전(준비 중)에는 마이페이지 &gt; 주문내역
              &gt; &ldquo;주문 취소&rdquo; 로 즉시 신청 가능. 배송이 시작된
              후 또는 수령 후 반품은 고객센터({business.email}) 로 1:1 접수해
              주세요.
        ...
        <Section title="7. 정기배송 해지 및 환불">
          <UL>
            ...
            <li>
              회원은 정기배송 관리 화면에서 정기배송을 해지할 수 있습니다.
            </li>
            <li>
