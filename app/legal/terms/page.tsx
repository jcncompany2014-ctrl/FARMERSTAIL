        ...
        <Article number={7} title="결제">
          <OL>
            ...
            <li>
              ...
              회차의 결제 예정일에 자동 청구됩니다. 회원은 정기배송 관리
              화면에서 다음 결제 전까지 해지할 수 있습니다.
            </li>
            <li>
          ...
          <OL>
            {/* ★2026-08-05 정정 — 두 조항이 사실과 달랐다.
                ...
                ② "결제 완료 후 평균 2영업일 이내 발송" : 실제는 **매주 화요일
                   하루 발송**(마감 일요일)이다. 월요일에 결제하면 발송까지
                   8일이다. 전자상거래법상 재화 공급 시기 표시가 부정확했고,
                   PG 심사가 읽는 문서다. */}
            <li>
            ...
            <li>
              ...
              일요일이며, 마감 이후 시작·변경된 주문은 다음 화요일 발송분에
              포함됩니다. 발송 후 수도권은 다음 날, 그 외 지역은 대체로 48시간
              이내에 도착하며 도서·산간은 하루 정도 더 걸릴 수 있습니다.
