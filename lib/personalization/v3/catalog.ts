...
export const BASE_SKUS: readonly BaseSku[] = [
  {
    ...
    claims: [
      {
        text: '낮은 열량 밀도(130kcal)로 체중 관리에 적합',
        grade: 'T2',
        basis: '4 SKU 중 최저 kcal/100g (마스터레시피 sheet7 as-fed 130)',
      },
      {
        text: '비타민 B3·B6가 풍부한',
        grade: 'T1',
  ...
  },
  {
    ...
    claims: [
      {
        text: '높은 열량 밀도(160kcal)로 고활동·증량에 적합',
        grade: 'T2',
        basis: '4 SKU 중 최고 kcal/100g (마스터레시피 sheet7 as-fed 160)',
      },
      {
